...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--region-mode", choices=("center", "jsonl", "identity"), default="center")
    ...
    parser.add_argument("--ptz-dead-zone", type=float, default=0.12)
    parser.add_argument("--ptz-min-speed", type=int, default=2)
    parser.add_argument("--ptz-max-speed", type=int, default=10)
    parser.add_argument(
        "--recovery-action",
